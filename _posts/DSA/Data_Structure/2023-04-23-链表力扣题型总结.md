...
1.   [86. 分隔链表 - 力扣（LeetCode）](https://leetcode.cn/problems/partition-list/);(类似合并排序链表, 可以用来做链表上的快排)
...
8.    [剑指 Offer II 029. 排序的循环链表](https://leetcode.cn/problems/4ueAj6/);
...
[148. 排序链表](https://leetcode.cn/problems/sort-list/); (这个是链表排序的最优解法: 归并排序)
